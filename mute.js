...
module.exports = (client) => {
  ...
  command(client, 'mute', async (message) => {
    ...
    if (!targetMember.hasPermission('ADMINISTRATOR' || 'MANAGE_MESSAGES')) {
      giveRole(targetMember)
      channel.send('Member Succesfully Muted!') }

    else message.channel.send('That user is a member of staff! Friendly fire is off dummy.')
